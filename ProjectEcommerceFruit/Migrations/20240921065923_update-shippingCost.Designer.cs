...
namespace ProjectEcommerceFruit.Migrations
{
    ...
    [Migration("20240921065923_update-shippingCost")]
    partial class updateshippingCost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectEcommerceFruit.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5447),
                            Detail = "",
                            Expire = new DateTime(2024, 10, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5448),
                            Hidden = false,
                            Price = 125.0,
                            ProductGIId = 1,
                            Quantity = 7,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5464),
                            Detail = "<p>1</p>",
                            Expire = new DateTime(2024, 10, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5465),
                            Hidden = false,
                            Price = 155.0,
                            ProductGIId = 2,
                            Quantity = 3,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5470),
                            Detail = "<p>111</p>",
                            Expire = new DateTime(2024, 10, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5471),
                            Hidden = false,
                            Price = 60.0,
                            ProductGIId = 3,
                            Quantity = 50,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5474),
                            Detail = "<p>111</p>",
                            Expire = new DateTime(2024, 10, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5475),
                            Hidden = false,
                            Price = 60.0,
                            ProductGIId = 4,
                            Quantity = 50,
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5479),
                            Detail = "<p></p>",
                            Expire = new DateTime(2024, 10, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5480),
                            Hidden = false,
                            Price = 40.0,
                            ProductGIId = 5,
                            Quantity = 10,
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5488),
                            Detail = "<p></p>",
                            Expire = new DateTime(2024, 10, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5489),
                            Hidden = false,
                            Price = 50.0,
                            ProductGIId = 5,
                            Quantity = 18,
            ...
            modelBuilder.Entity("ProjectEcommerceFruit.Models.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5276),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 21, 13, 59, 20, 392, DateTimeKind.Local).AddTicks(5300),
                            Description = "แหล่งผลิตที่ทองผาภูมิ",
                            Hidden = false,
                            Name = "อาปาชาเฮ้",
                            UserId = 2
            ...
            modelBuilder.Entity("ProjectEcommerceFruit.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin1",
                            Hidden = false,
                            PasswordHash = "$2a$11$buTzMXFlQJnwqbUFf3lKa.jCPiX.3mehb8xJpMgyNfXckUUTsseWa",
                        ...
                        new
                        {
                            ...
                            FullName = "User Haha",
                            Hidden = false,
                            PasswordHash = "$2a$11$pT55ErunDuMY5nmvem1VWulFdh9qqbZ1yCBO2QBF8QEKki4B1UFuS",
