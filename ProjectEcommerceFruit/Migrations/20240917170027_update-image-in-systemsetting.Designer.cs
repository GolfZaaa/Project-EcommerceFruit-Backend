...
namespace ProjectEcommerceFruit.Migrations
{
    ...
    [Migration("20240917170027_update-image-in-systemsetting")]
    partial class updateimageinsystemsetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectEcommerceFruit.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7412),
                            Detail = "",
                            Expire = new DateTime(2024, 10, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7413),
                            Price = 125.0,
                            ProductGIId = 1,
                            Quantity = 7,
                            Sold = 11,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7420),
                            Detail = "<p>1</p>",
                            Expire = new DateTime(2024, 10, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7421),
                            Price = 155.0,
                            ProductGIId = 2,
                            Quantity = 3,
                            Sold = 9,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7423),
                            Detail = "<p>111</p>",
                            Expire = new DateTime(2024, 10, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7424),
                            Price = 60.0,
                            ProductGIId = 3,
                            Quantity = 50,
                            Sold = 0,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7426),
                            Detail = "<p>111</p>",
                            Expire = new DateTime(2024, 10, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7427),
                            Price = 60.0,
                            ProductGIId = 4,
                            Quantity = 50,
                            Sold = 0,
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7428),
                            Detail = "<p></p>",
                            Expire = new DateTime(2024, 10, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7429),
                            Price = 40.0,
                            ProductGIId = 5,
                            Quantity = 10,
                            Sold = 0,
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7435),
                            Detail = "<p></p>",
                            Expire = new DateTime(2024, 10, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7436),
                            Price = 50.0,
                            ProductGIId = 5,
                            Quantity = 18,
                            Sold = 0,
            ...
            modelBuilder.Entity("ProjectEcommerceFruit.Models.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7280),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 18, 0, 0, 25, 283, DateTimeKind.Local).AddTicks(7299),
                            Description = "แหล่งผลิตที่ทองผาภูมิ",
                            Hidden = false,
                            Name = "อาปาชาเฮ้",
                            UserId = 2
            ...
            modelBuilder.Entity("ProjectEcommerceFruit.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin1",
                            Hidden = false,
                            PasswordHash = "$2a$11$nHQq.4GqcQUK3Q9xxqd50O94JAVXjswcdvmTiTzanL.0yqDfLpgJi",
                        ...
                        new
                        {
                            ...
                            FullName = "User Haha",
                            Hidden = false,
                            PasswordHash = "$2a$11$brEurHtwCnA31g32aARcXOqEvFI1HKAJwb7atdbpIbWGlGo/KxLuy",
